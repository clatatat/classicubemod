...
static const char* const GenLevel_TypeNames[] = { "Flat", "Normal", "Floating", "Caves", "Empty", "Strange", "3D Perlin" };
static const struct MapGenerator* GenLevel_TypeGens[] = { &FlatgrassGen, &NotchyGen, &FloatingGen, &CavesGen, &EmptyGen, &StrangeGen, &Perlin3DGen };
#define GENLEVEL_TYPE_COUNT 7
