...
public class Block {
	...
	static {
		...
		var10000 = (new BlockOreStorage(41, 39)).setHardness(3.0F).setResistance(10.0F);
		var1 = soundMetalFootstep;
		var0 = var10000;
		var0.stepSound = var1;
		blockGold = var0;
		var10000 = (new BlockOreStorage(42, 38)).setHardness(5.0F).setResistance(10.0F);
		var1 = soundMetalFootstep;
		var0 = var10000;
		var0.stepSound = var1;
		blockSteel = var0;
		...
		var0.stepSound = var1;
		oreDiamond = var0;
		var10000 = (new BlockOreStorage(57, 40)).setHardness(5.0F).setResistance(10.0F);
		var1 = soundMetalFootstep;
		var0 = var10000;
		var0.stepSound = var1;
		blockDiamond = var0;
