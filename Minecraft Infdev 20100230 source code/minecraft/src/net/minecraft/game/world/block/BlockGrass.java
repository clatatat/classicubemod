...
public final class BlockGrass extends Block {
	...
	public final void updateTick(World var1, int var2, int var3, int var4, Random var5) {
		if(var1.f(var2, var3 + 1, var4) < 4 && var1.getBlockMaterial(var2, var3 + 1, var4).getCanBlockGrass()) {
			if(var5.nextInt(4) == 0) {
				var1.setBlockWithNotify(var2, var3, var4, Block.dirt.blockID);
			}
		} else {
			if(var1.f(var2, var3 + 1, var4) >= 9) {
				var2 = var2 + var5.nextInt(3) - 1;
				var3 = var3 + var5.nextInt(5) - 3;
				var4 = var4 + var5.nextInt(3) - 1;
				if(var1.getBlockId(var2, var3, var4) == Block.dirt.blockID && var1.f(var2, var3 + 1, var4) >= 4 && !var1.getBlockMaterial(var2, var3 + 1, var4).getCanBlockGrass()) {
