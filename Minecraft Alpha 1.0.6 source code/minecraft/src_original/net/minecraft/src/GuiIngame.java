...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		boolean var10 = this.mc.thePlayer.aO / 3 % 2 == 1;
		if(this.mc.thePlayer.aO < 10) {
			var10 = false;
		}
		...
		if(this.mc.playerController.shouldDrawHUD()) {
			...
			if(this.mc.thePlayer.isInsideOfMaterial(Material.water)) {
				var14 = (int)Math.ceil((double)(this.mc.thePlayer.heartsLife - 2) * 10.0D / 300.0D);
				var15 = (int)Math.ceil((double)this.mc.thePlayer.heartsLife * 10.0D / 300.0D) - var14;
		...
		if(this.mc.options.d) {
			var8.drawStringWithShadow("Minecraft Alpha v1.0.6 (" + this.mc.debug + ")", 2, 2, 16777215);
			...
			var8.drawStringWithShadow("Minecraft Alpha v1.0.6", 2, 2, 16777215);
		}
