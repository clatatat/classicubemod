...
public abstract class Render {
	...
	private void renderEntityOnFire(Entity var1, double var2, double var4, double var6, float var8) {
		...
		float var19 = 0.5F;
		float var20 = 0.0F;
		float var21 = var1.width / var1.yOffset;
	...
	private void renderShadow(Entity var1, double var2, double var4, double var6, float var8, float var9) {
		...
		double var13 = var1.aA + (var1.posX - var1.aA) * (double)var9;
		double var15 = var1.lastTickPosX + (var1.posY - var1.lastTickPosX) * (double)var9;
		double var17 = var1.lastTickPosY + (var1.posZ - var1.lastTickPosY) * (double)var9;
