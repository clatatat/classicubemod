...
public class RenderGlobal implements IWorldAccess {
	...
	private RenderList[] R = new RenderList[]{new RenderList(), new RenderList(), new RenderList(), new RenderList()};
	...
	public void renderEntities(Vec3D var1, ICamera var2, float var3) {
		...
		this.renderEntitiesStartupCounter = 0;
		this.countEntitiesTotal = 0;
		this.countEntitiesRendered = 0;
		EntityPlayerSP var4 = this.mc.thePlayer;
		RenderManager.renderPosX = var4.aA + (var4.posX - var4.aA) * (double)var3;
		RenderManager.renderPosY = var4.lastTickPosX + (var4.posY - var4.lastTickPosX) * (double)var3;
		RenderManager.renderPosZ = var4.lastTickPosY + (var4.posZ - var4.lastTickPosY) * (double)var3;
		TileEntityRenderer.staticPlayerX = var4.aA + (var4.posX - var4.aA) * (double)var3;
		TileEntityRenderer.staticPlayerY = var4.lastTickPosX + (var4.posY - var4.lastTickPosX) * (double)var3;
		TileEntityRenderer.staticPlayerZ = var4.lastTickPosY + (var4.posZ - var4.lastTickPosY) * (double)var3;
		List var5 = this.theWorld.getLoadedEntityList();
		this.renderEntitiesStartupCounter = var5.size();
	...
	public String getDebugInfoRenders() {
		return "C: " + this.renderersBeingOccluded + "/" + this.countEntitiesHidden + ". F: " + this.renderersLoaded + ", O: " + this.renderersBeingClipped + ", E: " + this.renderersBeingRendered;
	}

	public String getDebugInfoEntities() {
		return "E: " + this.countEntitiesTotal + "/" + this.renderEntitiesStartupCounter + ". B: " + this.countEntitiesRendered + ", I: " + (this.renderEntitiesStartupCounter - this.countEntitiesRendered - this.countEntitiesTotal);
	}
	...
	public int sortAndRender(EntityPlayer var1, int var2, double var3) {
		...
		double var5 = var1.aA + (var1.posX - var1.aA) * var3;
		double var7 = var1.lastTickPosX + (var1.posY - var1.lastTickPosX) * var3;
		double var9 = var1.lastTickPosY + (var1.posZ - var1.lastTickPosY) * var3;
	...
	private int renderSortedRenderers(int var1, int var2, int var3, double var4) {
		...
		for(int var7 = var1; var7 < var2; ++var7) {
			...
			if(!this.sortedWorldRenderers[var7].skipRenderPass[var3] && this.sortedWorldRenderers[var7].isInFrustum && this.sortedWorldRenderers[var7].isVisible) {
				...
				if(var8 >= 0) {
					this.Q.add(this.sortedWorldRenderers[var7]);
					++var6;
				}
			}
		}
		...
		double var20 = var19.aA + (var19.posX - var19.aA) * var4;
		double var10 = var19.lastTickPosX + (var19.posY - var19.lastTickPosX) * var4;
		double var12 = var19.lastTickPosY + (var19.posZ - var19.lastTickPosY) * var4;
		int var14 = 0;

		int var15;
		for(var15 = 0; var15 < this.R.length; ++var15) {
			this.R[var15].reset();
		}

		for(var15 = 0; var15 < this.Q.size(); ++var15) {
			WorldRenderer var16 = (WorldRenderer)this.Q.get(var15);
			int var17 = -1;

			for(int var18 = 0; var18 < var14; ++var18) {
				if(this.R[var18].isRenderedAt(var16.posXMinus, var16.posYMinus, var16.posZMinus)) {
					var17 = var18;
				}
			}
			...
			if(var17 < 0) {
				var17 = var14++;
				this.R[var17].setLocation(var16.posXMinus, var16.posYMinus, var16.posZMinus, var20, var10, var12);
			}

			this.R[var17].render(var16.getGLCallListForPass(var3));
		}
	...
	public void renderClouds(float var1) {
		if(this.mc.options.fancyGraphics) {
			...
			float var2 = (float)(this.mc.thePlayer.lastTickPosX + (this.mc.thePlayer.posY - this.mc.thePlayer.lastTickPosX) * (double)var1);
			byte var3 = 32;
			int var4 = 256 / var3;
	...
	public void drawBlockBreaking(EntityPlayer var1, MovingObjectPosition var2, int var3, ItemStack var4, float var5) {
		...
		if(var3 == 0) {
			if(this.damagePartialTime > 0.0F) {
				...
				double var10 = var1.aA + (var1.posX - var1.aA) * (double)var5;
				double var12 = var1.lastTickPosX + (var1.posY - var1.lastTickPosX) * (double)var5;
				double var14 = var1.lastTickPosY + (var1.posZ - var1.lastTickPosY) * (double)var5;
	...
	public void drawSelectionBox(EntityPlayer var1, MovingObjectPosition var2, int var3, ItemStack var4, float var5) {
		if(var3 == 0 && var2.typeOfHit == 0) {
			...
			if(var7 > 0) {
				...
				double var8 = var1.aA + (var1.posX - var1.aA) * (double)var5;
				double var10 = var1.lastTickPosX + (var1.posY - var1.lastTickPosX) * (double)var5;
				double var12 = var1.lastTickPosY + (var1.posZ - var1.lastTickPosY) * (double)var5;
	...
	public void playSound(String var1, double var2, double var4, double var6, float var8, float var9) {
		...
		if(this.mc.thePlayer.getDistance(var2, var4, var6) < (double)(var10 * var10)) {
	...
	public void obtainEntitySkin(Entity var1) {
		if(var1.aQ != null) {
			this.renderEngine.obtainImageData(var1.aQ, new ImageBufferDownload());
		}
	...
	public void releaseEntitySkin(Entity var1) {
		if(var1.aQ != null) {
			this.renderEngine.releaseImageData(var1.aQ);
		}
