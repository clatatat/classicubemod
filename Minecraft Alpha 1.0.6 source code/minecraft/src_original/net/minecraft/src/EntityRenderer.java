...
public class EntityRenderer {
	...
	private Vec3D orientCamera2(float var1) {
	...
	private void getMouseOver(float var1) {
		...
		Vec3D var5 = this.orientCamera2(var1);
	...
	private void setupViewBobbing(float var1) {
		if(!this.mc.options.thirdPersonView) {
			EntityPlayerSP var2 = this.mc.thePlayer;
			float var3 = var2.prevDistanceWalkedModified - var2.height;
			float var4 = var2.prevDistanceWalkedModified + var3 * var1;
	...
	public void renderWorld(float var1) {
		...
		double var5 = var2.aA + (var2.posX - var2.aA) * (double)var1;
		double var7 = var2.lastTickPosX + (var2.posY - var2.lastTickPosX) * (double)var1;
		double var9 = var2.lastTickPosY + (var2.posZ - var2.lastTickPosY) * (double)var1;
		...
		for(int var11 = 0; var11 < 2; ++var11) {
			...
			var3.renderEntities(this.orientCamera2(var1), var12, var1);
	...
	private void renderSnow(float var1) {
		...
		double var8 = var2.aA + (var2.posX - var2.aA) * (double)var1;
		double var10 = var2.lastTickPosX + (var2.posY - var2.lastTickPosX) * (double)var1;
		double var12 = var2.lastTickPosY + (var2.posZ - var2.lastTickPosY) * (double)var1;
		byte var14 = 5;
		if(this.mc.options.fancyGraphics) {
			var14 = 10;
		}
