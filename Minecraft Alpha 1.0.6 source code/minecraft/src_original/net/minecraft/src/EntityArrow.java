...
public class EntityArrow extends Entity {
	...
	public void setArrowHeading(double var1, double var3, double var5, float var7, float var8) {
		...
		var3 /= (double)var9;
		var5 /= (double)var9;
		var1 += this.aI.nextGaussian() * (double)0.0075F * (double)var8;
		var3 += this.aI.nextGaussian() * (double)0.0075F * (double)var8;
		var5 += this.aI.nextGaussian() * (double)0.0075F * (double)var8;
		var1 *= (double)var7;
		var3 *= (double)var7;
		var5 *= (double)var7;
		this.motionX = var1;
	...
	public void i_() {
		...
		if(this.inData) {
			...
			this.inData = false;
			this.motionX *= (double)(this.aI.nextFloat() * 0.2F);
			this.motionY *= (double)(this.aI.nextFloat() * 0.2F);
			this.motionZ *= (double)(this.aI.nextFloat() * 0.2F);
			this.ticksInGround = 0;
			this.ticksInAir = 0;
		} else {
			++this.ticksInAir;
		...
		if(var3 != null) {
			if(var3.entityHit != null) {
				if(var3.entityHit.attackEntityFrom(this.shootingEntity, 4)) {
					this.worldObj.playSoundAtEntity(this, "random.drr", 1.0F, 1.2F / (this.aI.nextFloat() * 0.2F + 0.9F));
					this.setEntityDead();
				} else {
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		if(this.inData && this.shootingEntity == var1 && this.arrowShake <= 0 && var1.inventory.addItemStackToInventory(new ItemStack(Item.arrow.shiftedIndex, 1))) {
			this.worldObj.playSoundAtEntity(this, "random.pop", 0.2F, ((this.aI.nextFloat() - this.aI.nextFloat()) * 0.7F + 1.0F) * 2.0F);
