...
public class EntitySheep extends EntityAnimal {
	...
	public boolean attackEntityFrom(Entity var1, int var2) {
		if(!this.sheared && var1 instanceof EntityLiving) {
			this.sheared = true;
			int var3 = 1 + this.aI.nextInt(3);

			for(int var4 = 0; var4 < var3; ++var4) {
				EntityItem var5 = this.entityDropItem(Block.cloth.blockID, 1, 1.0F);
				var5.motionY += (double)(this.aI.nextFloat() * 0.05F);
				var5.motionX += (double)((this.aI.nextFloat() - this.aI.nextFloat()) * 0.1F);
				var5.motionZ += (double)((this.aI.nextFloat() - this.aI.nextFloat()) * 0.1F);
			}
		}
