...
public class RenderManager {
	...
	private RenderManager() {
		...
		this.entityRenderMap.put(EntitySheep.class, new RenderSheep(new ModelSheep(), new ModelCow(), 0.7F));
	...
	public void cacheActiveRenderInfo(World var1, RenderEngine var2, FontRenderer var3, EntityPlayer var4, GameSettings var5, float var6) {
		...
		this.viewerPosX = var4.aA + (var4.posX - var4.aA) * (double)var6;
		this.viewerPosY = var4.lastTickPosX + (var4.posY - var4.lastTickPosX) * (double)var6;
		this.viewerPosZ = var4.lastTickPosY + (var4.posZ - var4.lastTickPosY) * (double)var6;
	}

	public void renderEntity(Entity var1, float var2) {
		double var3 = var1.aA + (var1.posX - var1.aA) * (double)var2;
		double var5 = var1.lastTickPosX + (var1.posY - var1.lastTickPosX) * (double)var2;
		double var7 = var1.lastTickPosY + (var1.posZ - var1.lastTickPosY) * (double)var2;
