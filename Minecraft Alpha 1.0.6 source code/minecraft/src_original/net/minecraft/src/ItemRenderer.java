...
public class ItemRenderer {
	...
	public void renderItemInFirstPerson(float var1) {
		...
		if(this.itemToRender != null) {
			...
			GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTextureForDownloadableImage(this.mc.thePlayer.aQ, this.mc.thePlayer.getTexture()));
	...
	public void renderOverlays(float var1) {
		...
		int var2;
		if(this.mc.thePlayer.fireResistance > 0) {
