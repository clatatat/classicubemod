...
public class EntityItem extends Entity {
	...
	public void i_() {
		...
		if(this.worldObj.getBlockMaterial(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)) == Material.lava) {
			this.motionY = (double)0.2F;
			this.motionX = (double)((this.aI.nextFloat() - this.aI.nextFloat()) * 0.2F);
			this.motionZ = (double)((this.aI.nextFloat() - this.aI.nextFloat()) * 0.2F);
			this.worldObj.playSoundAtEntity(this, "random.fizz", 0.4F, 2.0F + this.aI.nextFloat() * 0.4F);
		}
	...
	private boolean a(double var1, double var3, double var5) {
		...
		if(Block.opaqueCubeLookup[this.worldObj.getBlockId(var7, var8, var9)]) {
			...
			float var25 = this.aI.nextFloat() * 0.2F + 0.1F;
			if(var22 == 0) {
