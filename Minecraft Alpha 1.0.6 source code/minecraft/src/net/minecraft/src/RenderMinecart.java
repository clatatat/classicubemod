...
public class RenderMinecart extends Render {
	...
	public void renderMinecart(EntityMinecart var1, double var2, double var4, double var6, float var8, float var9) {
		GL11.glPushMatrix();
		double var10 = var1.aA + (var1.posX - var1.aA) * (double)var9;
		double var12 = var1.lastTickPosX + (var1.posY - var1.lastTickPosX) * (double)var9;
		double var14 = var1.lastTickPosY + (var1.posZ - var1.lastTickPosY) * (double)var9;
		double var16 = (double)0.3F;
		Vec3D var18 = var1.a(var10, var12, var14);
