...
public class EntityExplodeFX extends EntityFX {
	public EntityExplodeFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
		...
		this.particleRed = this.particleGreen = this.particleBlue = this.aI.nextFloat() * 0.3F + 0.7F;
		this.particleScale = this.aI.nextFloat() * this.aI.nextFloat() * 6.0F + 1.0F;
		this.particleMaxAge = (int)(16.0D / ((double)this.aI.nextFloat() * 0.8D + 0.2D)) + 2;
	}
