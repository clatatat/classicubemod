...
public class EntitySkeleton extends EntityMob {
	...
	public void onLivingUpdate() {
		if(this.worldObj.isDaytime()) {
			...
			if(var1 > 0.5F && this.worldObj.canBlockSeeTheSky(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)) && this.aI.nextFloat() * 30.0F < (var1 - 0.4F) * 2.0F) {
	...
	protected void attackEntity(Entity var1, float var2) {
		if(var2 < 10.0F) {
			...
			if(this.attackTime == 0) {
				...
				this.worldObj.playSoundAtEntity(this, "random.bow", 1.0F, 1.0F / (this.aI.nextFloat() * 0.4F + 0.8F));
