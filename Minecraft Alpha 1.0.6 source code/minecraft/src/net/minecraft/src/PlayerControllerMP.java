...
public class PlayerControllerMP extends PlayerController {
	...
	public boolean sendBlockRemoved(int var1, int var2, int var3) {
		this.netClientHandler.addToSendQueue(new Packet14BlockDig(3, var1, var2, var3, 0));
	...
	public void clickBlock(int var1, int var2, int var3) {
		...
		this.netClientHandler.addToSendQueue(new Packet14BlockDig(0, var1, var2, var3, 0));
		int var4 = this.mc.theWorld.getBlockId(var1, var2, var3);
	...
	public boolean onPlayerRightClick(EntityPlayer var1, World var2, ItemStack var3, int var4, int var5, int var6, int var7) {
		this.syncCurrentPlayItem();
		this.netClientHandler.addToSendQueue(new Packet15Place(var3.itemID, var4, var5, var6, var7));
