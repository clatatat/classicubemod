...
public class Pathfinder {
	...
	private PathEntity createEntityPathTo(Entity var1, double var2, double var4, double var6, float var8) {
		...
		PathPoint var10 = this.openPoint(MathHelper.floor_double(var2 - (double)(var1.yOffset / 2.0F)), MathHelper.floor_double(var4), MathHelper.floor_double(var6 - (double)(var1.yOffset / 2.0F)));
		PathPoint var11 = new PathPoint(MathHelper.floor_float(var1.yOffset + 1.0F), MathHelper.floor_float(var1.width + 1.0F), MathHelper.floor_float(var1.yOffset + 1.0F));
