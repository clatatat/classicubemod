...
public class EntityFlameFX extends EntityFX {
	...
	public EntityFlameFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
		...
		double var10000 = var2 + (double)((this.aI.nextFloat() - this.aI.nextFloat()) * 0.05F);
		var10000 = var4 + (double)((this.aI.nextFloat() - this.aI.nextFloat()) * 0.05F);
		var10000 = var6 + (double)((this.aI.nextFloat() - this.aI.nextFloat()) * 0.05F);
