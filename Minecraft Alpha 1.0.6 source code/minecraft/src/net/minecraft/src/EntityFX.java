...
public class EntityFX extends Entity {
	...
	public EntityFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
		...
		this.particleTextureJitterX = this.aI.nextFloat() * 3.0F;
		this.particleTextureJitterY = this.aI.nextFloat() * 3.0F;
		this.particleScale = (this.aI.nextFloat() * 0.5F + 0.5F) * 2.0F;
		this.particleMaxAge = (int)(4.0F / (this.aI.nextFloat() * 0.9F + 0.1F));
		this.particleAge = 0;
		this.ay = false;
	}
