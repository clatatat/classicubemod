...
public class TileEntityRenderer {
	...
	public void cacheActiveRenderInfo(World var1, RenderEngine var2, FontRenderer var3, EntityPlayer var4, float var5) {
		...
		this.playerX = var4.aA + (var4.posX - var4.aA) * (double)var5;
		this.playerY = var4.lastTickPosX + (var4.posY - var4.lastTickPosX) * (double)var5;
		this.playerZ = var4.lastTickPosY + (var4.posZ - var4.lastTickPosY) * (double)var5;
	}
