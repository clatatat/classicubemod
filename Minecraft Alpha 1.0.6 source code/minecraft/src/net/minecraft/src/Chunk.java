...
public class Chunk {
	...
	private void checkSkylightNeighborHeight(int var1, int var2, int var3) {
		...
		if(var4 > var3) {
			this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Sky, var1, var3, var2, var1, var4, var2);
		} else if(var4 < var3) {
			this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Sky, var1, var4, var2, var1, var3, var2);
		}
	...
	private void relightBlock(int var1, int var2, int var3) {
		...
		if(var5 != var4) {
			...
			if(var5 < var4) {
				...
				this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Sky, var6, var4, var7, var6, var5, var7);
			...
			if(var5 != var9) {
				this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Sky, var6 - 1, var5, var7 - 1, var6 + 1, var9, var7 + 1);
			}
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		if(var8 == var4) {
			...
			this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Sky, var9, var2, var10, var9, var2, var10);
			this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Block, var9, var2, var10, var9, var2, var10);
	...
	public boolean setBlockID(int var1, int var2, int var3, int var4) {
		...
		if(var7 == var4) {
			...
			this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Sky, var8, var2, var9, var8, var2, var9);
			this.worldObj.scheduleLightingUpdate_do(EnumSkyBlock.Block, var8, var2, var9, var8, var2, var9);
			this.updateSkylight_do(var1, var3);
