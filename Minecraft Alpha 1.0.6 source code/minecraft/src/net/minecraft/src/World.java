...
public class World implements IBlockAccess {
	...
	private void notifyBlockChange(int var1, int var2, int var3, int var4) {
	...
	public void neighborLightPropagationChanged(EnumSkyBlock var1, int var2, int var3, int var4, int var5) {
		if(this.blockExists(var2, var3, var4)) {
			...
			if(this.getSavedLightValue(var1, var2, var3, var4) != var5) {
				this.scheduleLightingUpdate_do(var1, var2, var3, var4, var2, var3, var4);
			}
	...
	public void playSoundAtEntity(Entity var1, String var2, float var3, float var4) {
		for(int var5 = 0; var5 < this.worldAccesses.size(); ++var5) {
			((IWorldAccess)this.worldAccesses.get(var5)).playSound(var2, var1.posX, var1.posY - (double)var1.at, var1.posZ, var3, var4);
		}
	...
	public void spawnEntityInWorld(Entity var1) {
		...
		if(!var4 && !this.chunkExists(var2, var3)) {
			System.out.println("Failed to add entity " + var1 + " because the chunk wasn\'t loaded");
		} else {
			this.getChunkFromChunkCoords(var2, var3).addEntity(var1);
			this.loadedEntityList.add(var1);

			for(int var5 = 0; var5 < this.worldAccesses.size(); ++var5) {
				((IWorldAccess)this.worldAccesses.get(var5)).obtainEntitySkin(var1);
			}
		}
	...
	public List getCollidingBoundingBoxes(Entity var1, AxisAlignedBB var2) {
		...
		for(int var15 = 0; var15 < var14.size(); ++var15) {
			AxisAlignedBB var13 = ((Entity)var14.get(var15)).e_();
			if(var13 != null) {
	...
	public void updateEntities() {
		...
		for(var1 = 0; var1 < this.playerEntities.size(); ++var1) {
			if(!this.loadedEntityList.contains(this.playerEntities.get(var1))) {
				System.out.println("Reinserting player " + var1);
				this.spawnEntityInWorld((Entity)this.playerEntities.get(var1));
			}
		}
		...
		for(var1 = 0; var1 < this.loadedEntityList.size(); ++var1) {
			...
			if(var6.ridingEntity != null) {
				if(!var6.ridingEntity.surfaceCollision && var6.ridingEntity.riddenByEntity == var6) {
					continue;
				}
	...
	private void updateEntity(Entity var1) {
		...
		if(this.checkChunksExist(var2 - var4, 0, var3 - var4, var2 + var4, 128, var3 + var4)) {
			var1.aA = var1.posX;
			var1.lastTickPosX = var1.posY;
			var1.lastTickPosY = var1.posZ;
			...
			int var9 = MathHelper.floor_double(var1.posY / 16.0D);
			int var10 = MathHelper.floor_double(var1.posZ / 16.0D);
			if(var5 != var8 || var6 != var9 || var7 != var10) {
				if(this.chunkExists(var5, var7)) {
					this.getChunkFromChunkCoords(var5, var7).removeEntityAtIndex(var1, var6);
				}

				if(this.chunkExists(var8, var10)) {
			...
			if(var1.riddenByEntity != null) {
				if(!var1.riddenByEntity.surfaceCollision && var1.riddenByEntity.ridingEntity == var1) {
			...
			if(Double.isNaN(var1.posY) || Double.isInfinite(var1.posY)) {
				var1.posY = var1.lastTickPosX;
			}

			if(Double.isNaN(var1.posZ) || Double.isInfinite(var1.posZ)) {
				var1.posZ = var1.lastTickPosY;
			}
	...
	public boolean checkIfAABBIsClear(AxisAlignedBB var1) {
		...
		for(int var3 = 0; var3 < var2.size(); ++var3) {
			...
			if(!var4.surfaceCollision && var4.preventEntitySpawning) {
				return false;
			}
		}
		...
		while(var12.hasNext()) {
			...
			if(this.soundCounter == 0) {
				...
				if(var10 == 0 && this.getBlockLightValue(var7, var9, var8) <= this.rand.nextInt(8) && this.getSavedLightValue(EnumSkyBlock.Sky, var7, var9, var8) <= 0) {
					...
					if(var11 != null && var11.getDistance((double)var7 + 0.5D, (double)var9 + 0.5D, (double)var8 + 0.5D) > 4.0D) {
			...
			for(var6 = 0; var6 < 80; ++var6) {
				...
				var9 = var7 >> 8 & 15;
				var10 = var7 >> 16 & 127;
				int var15 = var14.getBlockID(var8, var10, var9);
	...
	public EntityPlayer getClosestPlayer(double var1, double var3, double var5, double var7) {
		...
		for(int var12 = 0; var12 < this.playerEntities.size(); ++var12) {
			...
			double var14 = var13.getDistance(var1, var3, var5);
