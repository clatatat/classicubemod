...
public class EntityCreature extends EntityLiving {
	...
	protected void updateEntityActionState() {
		...
		if(this.entityToAttack == null) {
			...
			if(this.b(this.entityToAttack)) {
				this.attackEntity(this.entityToAttack, var2);
			}
		}

		if(this.hasAttacked || this.entityToAttack == null || this.pathToEntity != null && this.aI.nextInt(20) != 0) {
			if(this.pathToEntity == null && this.aI.nextInt(80) == 0 || this.aI.nextInt(80) == 0) {
				boolean var21 = false;
				int var3 = -1;
				int var4 = -1;
				int var5 = -1;
				...
				for(int var7 = 0; var7 < 10; ++var7) {
					int var8 = MathHelper.floor_double(this.posX + (double)this.aI.nextInt(13) - 6.0D);
					int var9 = MathHelper.floor_double(this.posY + (double)this.aI.nextInt(7) - 3.0D);
					int var10 = MathHelper.floor_double(this.posZ + (double)this.aI.nextInt(13) - 6.0D);
		...
		boolean var23 = this.f_();
		boolean var24 = this.handleLavaMovement();
		this.rotationPitch = 0.0F;
		if(this.pathToEntity != null && this.aI.nextInt(100) != 0) {
			...
			if(this.aI.nextFloat() < 0.8F && (var23 || var24)) {
				this.isJumping = true;
			}
	...
	public boolean a(double var1, double var3, double var5) {
		return super.a(var1, var3, var5) && this.getBlockPathWeight((int)var1, (int)var3, (int)var5) >= 0.0F;
	}
}
