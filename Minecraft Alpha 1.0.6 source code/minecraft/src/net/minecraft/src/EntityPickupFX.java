...
public class EntityPickupFX extends EntityFX {
	...
	public void renderParticle(Tessellator var1, float var2, float var3, float var4, float var5, float var6, float var7) {
		...
		double var15 = this.entityPickingUp.aA + (this.entityPickingUp.posX - this.entityPickingUp.aA) * (double)var2;
		double var17 = this.entityPickingUp.lastTickPosX + (this.entityPickingUp.posY - this.entityPickingUp.lastTickPosX) * (double)var2 + (double)this.yOffs;
		double var19 = this.entityPickingUp.lastTickPosY + (this.entityPickingUp.posZ - this.entityPickingUp.lastTickPosY) * (double)var2;
		...
		int var28 = MathHelper.floor_double(var23 + (double)(this.at / 2.0F));
