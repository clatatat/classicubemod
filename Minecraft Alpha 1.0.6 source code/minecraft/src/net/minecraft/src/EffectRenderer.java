...
public class EffectRenderer {
	...
	public void renderParticles(Entity var1, float var2) {
		...
		EntityFX.interpPosX = var1.aA + (var1.posX - var1.aA) * (double)var2;
		EntityFX.interpPosY = var1.lastTickPosX + (var1.posY - var1.lastTickPosX) * (double)var2;
		EntityFX.interpPosZ = var1.lastTickPosY + (var1.posZ - var1.lastTickPosY) * (double)var2;
